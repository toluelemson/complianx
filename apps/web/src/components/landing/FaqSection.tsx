...
export function FaqSection() {
  ...
  return (
    <section
      ...
      className="bg-[#f8fafc] px-5 py-28 sm:px-8 lg:px-10"
    >
        ...
        <div className="mt-16 space-y-3">
          {visibleItems.map((item, index) => {
            ...
            return (
              <div
                key={item.question}
                className="rounded-[1.6rem] border border-slate-200 bg-white transition-colors duration-300 hover:border-slate-300"
              >
                <button
                  type="button"
