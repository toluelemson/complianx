          ...
          <CardContent className="flex flex-col gap-8 p-8 sm:p-10 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-3xl">
              ...
              <h2 className="mt-4 text-4xl font-semibold tracking-tight text-white sm:text-5xl">
                Get your first compliance documentation pack without building it
                yourself
              </h2>
              <p className="mt-4 text-base leading-8 text-slate-300">
                Submit your system, align scope, and receive audit-ready
                materials with first delivery in as little as 48 hours.
              </p>
            </div>
