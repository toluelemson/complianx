...
import { generateDemoReport } from '@/domains/regulatory-frameworks/api';
            ...
            <div className="space-y-6 xl:sticky xl:top-24 xl:h-fit">
              <Card className="border-slate-200/90 bg-white/95 shadow-[0_30px_80px_-56px_rgba(15,23,42,0.3)]">
                <CardHeader>
                  ...
                  <CardDescription>Loan approval AI scenario.</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  ...
                  <Field label="Input data">
                    <Textarea
                      ...
                      onChange={(event) =>
                        update('inputData', event.target.value)
                      }
                    />
                  </Field>
                  <Field label="Output / decision">
                    <Textarea
                      value={form.outputDecision}
                      onChange={(event) =>
                        update('outputDecision', event.target.value)
                      }
                    />
                  </Field>
                  <Field label="Affected stakeholders">
                    <Textarea
                      ...
                      onChange={(event) =>
                        update('stakeholders', event.target.value)
                      }
                    />
                  </Field>
                  <div className="grid gap-4 sm:grid-cols-2">
                    <Field label="Operator role">
                      <Select
                        ...
                        onChange={(event) =>
                          update('operatorRole', event.target.value)
                        }
                      >
                    ...
                    <Field label="Geography">
                      <Input
                        ...
                        onChange={(event) =>
                          update('geography', event.target.value)
                        }
                      />
                    </Field>
                  </div>
                  <Field label="High-risk context">
                    <Select
                      value={form.highRiskContext}
                      onChange={(event) =>
                        update('highRiskContext', event.target.value)
                      }
                    >
                      <option value="Access to essential services, credit, insurance, or benefits">
                        Access to essential services, credit, insurance, or
                        benefits
                      </option>
                  ...
                  <Field label="Human oversight status">
                    <Textarea
                      value={form.oversightStatus}
                      onChange={(event) =>
                        update('oversightStatus', event.target.value)
                      }
                    />
                  </Field>
                  <Field label="Risk controls status">
                    <Textarea
                      value={form.controlsStatus}
                      onChange={(event) =>
                        update('controlsStatus', event.target.value)
                      }
                    />
                  </Field>
                  <Field label="Documentation status">
                    <Textarea
                      ...
                      onChange={(event) =>
                        update('documentationStatus', event.target.value)
                      }
                    />
                  </Field>
                  <Field label="Conformity status">
                    <Textarea
                      value={form.conformityStatus}
                      onChange={(event) =>
                        update('conformityStatus', event.target.value)
                      }
                    />
                  </Field>
