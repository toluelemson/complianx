  ...
  const mutation = useMutation({
    mutationFn: (values: SubmitSystemFormValues) =>
      api
        ...
        .then((res) => res.data),
    onSuccess: () => {
      setStatusMessage("Thanks. We've received your system and will get back to you shortly.");
      reset();
    },
    onError: (err: any) => {
      setStatusMessage(
            ...
            <CardContent className="p-8 sm:p-10">
              ...
              <div className="mt-6 grid gap-4 sm:grid-cols-3">
                <div className="rounded-[1.25rem] border border-slate-200 bg-white p-4">
                  ...
                  <p className="mt-1 text-xs text-slate-500">2-4 day turnaround</p>
                </div>
                <div className="rounded-[1.25rem] border border-slate-200 bg-white p-4">
                  <p className="text-xs font-semibold uppercase tracking-[0.24em] text-slate-400">
                    Professional
                  ...
                  <p className="mt-1 text-xs text-slate-500">Most common engagement</p>
                </div>
                <div className="rounded-[1.25rem] border border-slate-200 bg-white p-4">
                  <p className="text-xs font-semibold uppercase tracking-[0.24em] text-slate-400">
                    Enterprise
              ...
              >
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <label className="block text-sm font-medium text-slate-700">
                    Company
                    <Input type="text" {...register('company')} className="mt-2" />
                  </label>
                  <label className="block text-sm font-medium text-slate-700">
                    AI system name
                    <Input
